...
private val IMPORT_CONFIGS_LLM: List<Config> =
  listOf(
    ...
    BooleanSwitchConfig(key = ConfigKey.SUPPORT_IMAGE, defaultValue = true),
...
fun ModelImportDialog(
  ...
  defaultSupportImage: Boolean = false
) {
  ...
  val initialValues: Map<String, Any> = remember {
    mutableMapOf<String, Any>().apply {
      ...
      // Override image support default based on context
      put(ConfigKey.SUPPORT_IMAGE.label, defaultSupportImage)
    }
  }
